				...
				<div class="span9">
					<div class="card mb-4">
						<div class="card-header">
							...
							<form action="afficherListeProduits.php" method="POST">
							<input type="submit" class="button" value="Reset">
							</form>
						</div>
							<div class="card-body">
								<div class="table-sortable">
									<table border="1" align="center" cellpadding="0" cellspacing="0" border="0" class="table table-sm table-bordered table-sortable table-striped display" id="tableProduits" width="100%">
										<thead>
											<tr>
