                           ...
                           <div class="navbar-collapse">	
                              <div class="nav-inner">	
                                 <ul class="nav main-menu menu navbar-nav">
                                    <li ><a href="affichercommande.php">afficher tous les commandes</a></li>
                                    <li class="active"><a href="afficherpanier.php">afficher tous les paniers</a></li>												
						...
						$a=1;
						 foreach($listepanier as $row) { ?>
							<tr>
								...
								<td class="action" data-title="Remove"><a  href="supprimerpanier.php?id=<?php echo $row['id_panier'];?>"><i></i>suprimmer</a></td>
							</tr>
