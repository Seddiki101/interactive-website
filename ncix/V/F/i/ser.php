<?php
	...
	$servo=$serviceC->findservicebyctg($_POST['ID_cs']);
			}
	

if(isset($_POST['likes'])){
		$serviceC->incrementlikes($servo['IDs']);
			...
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main" class="alt">
                        ...
                        <button type="button" class="like-button" style="display: block;
    					margin: 10px ;" name="like"><i class="fa fa-thumbs-up"></i> like</button>
...
<br/>
								                ...
								                <div class="col-sm-4">
								                  	...
								                  	<div class="col-sm-6">
															  ...
															  <a href="ajouterpanier2.php?id_article2=<?php echo $servo['IDs'];?>"> add to cart </a>
													   </div>	
													</div>
