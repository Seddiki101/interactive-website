<?php
    //include_once 'B:\apps\xampp\htdocs\Ht\M\CS.php';
    //include_once 'B:\apps\xampp\htdocs\Ht\C\CSC.php';
...
<head>
	...
	<!-- here insert ckeditor script HOE-->
...
<button><a href="afficherSe.php">Retour à la liste des services</a></button>
        ...
        <form action="" method="POST">
             <table border="0" class="table table-striped" align="center">
                    ...
                    <input hidden type="hidden" name="IDs" id="IDs" value="<?php echo $service['IDs']; ?>" >
                ...
                <tr>
                    ...
                    <td><input type="file" name="image_ser" id="image_ser" value="<?php echo $service['image_ser']; ?>"></td>
                </tr>
                <tr>
                    <td>
