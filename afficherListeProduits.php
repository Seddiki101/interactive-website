...
<head>
	...
	<title>Espace Admin Produits</title>
...
<body>
			...
			<div class="row">
				<div class="span3">
					<div class="sidebar">
						...
						<ul class="widget widget-menu unstyled">
                                <li><a href="ajoutCategorie.html"><i class="menu-icon icon-bold"></i> Ajouter Categorie</a></li>
                                <li><a href="ui-typography.html"><i class="menu-icon icon-book"></i>Afficher Categories </a></li>
	...
	<div class="footer">
		<div class="container">
			...
			<b class="copyright">&copy; 2021  Ncix -  </b> 
		</div>
	</div>
